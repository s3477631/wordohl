...
const eightLetterWords = ["dialyzer", "dialyzes", "diamante", "diameter", "diamides", "diamines",
    "diamonds", "dianthus",
...
function submitGuess() {
    ...
    if (activeTiles.length != WORD_LENGTH) {
        console.log('compared lengths,: ', activeTiles.length, WORD_LENGTH)
    ...
    if (WORD_LENGTH == 9) {
        if (!eightLetterWords.includes(guess)) {
            showAlert("Not in word list")
            shakeTiles(activeTiles)
            return
        }
...
const getWordLength = () => {
    ...
    if (WORD_LENGTH == 6) {
        targetWord = sixLetters[getRandomInt(sixLetters.length)]
    }
    if (WORD_LENGTH == 8) {
